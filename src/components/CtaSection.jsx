...
export default function CtaSection() {
  return (
    <section className="max-w-7xl mx-auto px-10 md:px-15 py-15 md:py-20 flex flex-col md:flex-row items-center gap-8 md:gap-12">
      {/* Text Content */}
      <div className="md:flex-1 max-w-xl text-center md:text-left">
        ...
        <p className="text-sm sm:text-base text-gray-700 mb-6 leading-relaxed">
          With CredPal, you turn interest into action. Offer flexible credit at
          checkout, increase sales and attract customers who spend more, all
